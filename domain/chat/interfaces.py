...
class IModelProvider(ABC):
    ...
    @abstractmethod
    def generate_response(self, user_input: str, conversation_history: List[ChatMessage]) -> str:
    ...
    @abstractmethod
    def generate_response_stream(self, user_input: str, conversation_history: List[ChatMessage]) -> Iterator[str]:
